...
Experienced programming in Python, familiar with pandas, numpy, scikit-learn, some experience with pytorch, dask, and sqlachemy. Experienced using Git. Beginner SQL. I am currently learning to use docker as we transition to AWS. Experienced working with Linux; I currently administer my companies linux server.
